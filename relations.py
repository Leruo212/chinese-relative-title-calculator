...
# ==================== 基础关系定义 ====================
# 每个关系: {关系key: {"male": 男性称呼, "female": 女性称呼, "desc": 描述}}
# 关系key由路径构成，例如 "father.brother" 表示父亲的兄弟
...
# ==================== 合并所有关系 ====================
ALL_RELATIONS = {}
ALL_RELATIONS.update(DIRECT_RELATIONS)
ALL_RELATIONS.update(PATERNAL_RELATIONS)
ALL_RELATIONS.update(MATERNAL_RELATIONS)
ALL_RELATIONS.update(SPOUSE_RELATIONS)
...
# 用于界面展示的关系树（选项化）
# 格式: [("显示名", "关系key", "性别(male/female/both)")]
RELATION_OPTIONS = [
    # ===== 直系 =====
    ("父亲", "father", "male"),
    ("母亲", "mother", "female"),
